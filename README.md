...
*port_number can be any port number. 

or from the root directory
```cd app | npm run build | npx serve -s dist -l port_number``
...
If you wanna circumvent those, run the backend on a laptop, preferably with Wifi instead of Ethernet 
